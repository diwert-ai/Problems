"""
Структура данных heap (куча или пирамида) и сортировка массива
...
2. Потомки либо всегда не меньше (и тогда в корне минимум) своего родителя
  либо всегда не больше (и тогда в корне максимум).
3. Глубина листьев отличается не более чем на 1.
4. Уровни двоичного дерева заполняются без пропусков.
"""
