...
пи функции от префикса, найденного на предыдущем шаге, которое дает нам длину следующего по величение префикса и суффикса
для проверки на совпадение символа идущего за новым префиксом  с добавляемым симвлом  x - и так до тех пока не встретится совпадение, 
либо искомое значение будет равна 0.
'''
